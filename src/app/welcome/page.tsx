...
const features = [
  ...
  },
  {
    ...
    description:
      'Invite your team, track API costs per user, set budgets, manage roles.',
    icon: 'T',
  ...
  },
  {
    title: 'Cost Tracking',
    description:
      'See exactly what you\'re spending on AI. Per-call logging, monthly dashboards, budget alerts.',
    icon: 'CT',
