...
import { getRenderQueue, getVideoGenQueue, getLongformQueue, getAvatarQueue } from '@/lib/queue';
...
export async function GET(
  ...
  if (!type || !['render', 'video-gen', 'longform', 'avatar'].includes(type)) {
